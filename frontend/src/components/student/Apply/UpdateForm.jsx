...
//                 selected={selectedCompanies.has(company.company_id)}
//               >
//                 <option value="">select</option>
...
//                     selected={
//                       studentPreferences[preferenceIndex] === company.company_id
//                     }
//                   >
          ...
          {companies.map((company, preferenceIndex) => (
            ...
            >
              ...
              <SelectStyled
                ...
                onChange={(e) => handlePreferenceChange(e, preferenceIndex)}
                invalid={errors.preferences[preferenceIndex]}
                selected={studentPreferences
                  .slice(0, preferenceIndex)
                  .includes(company.company_id)}
              >
                <option value="">select</option>
                {companies.map((cmp) => (
                  <option key={cmp.company_id} value={cmp.company_id}>
                    {cmp.company_name}
                  </option>
                ))}
              </SelectStyled>
